// MainModules\AtheleteStore\StoreCoachListing\page.tsx
...
// import { CoachBadge } from '../../AtheleteStore/page';
import { SourcingModelBadge } from '../../AtheleteStore/page';
                        ...
                        <div className="flex flex-col gap-3 px-4 pt-4">
                            {filteredCoaches.map((coach) => (
                                <div
                                    ...
                                    onClick={() => router.push(`/MainModules/AtheleteStore/StoreCoachProfile/${coach.id}${selectedServiceType ? `?serviceType=${selectedServiceType}` : ''}`)}
                                >
                                    <div className="p-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between">
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="mt-1">
                                                            <SourcingModelBadge type={coach.sourcing_model || 'independent'} />
                                                        </div>
                                                    </div>
                                                    <button
