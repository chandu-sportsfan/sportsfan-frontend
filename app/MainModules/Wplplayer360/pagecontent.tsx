...
// import { Search, ChevronRight, Trophy, Zap, Target } from "lucide-react";
...
//   if (role === "All-Rounder") return "from-violet-600 to-fuchsia-500";
//   if (role === "Bowler") return "from-violet-700 to-indigo-500";
//   return "from-fuchsia-600 to-violet-500";
// }
...
// function headlineStat(player: WPLPlayer): { label: string; value: string } {
//   const hasBowl = player.wickets > 0;
//   const hasBat = player.runs > 0;
//   if (hasBat && player.runs >= player.wickets * 10) {
//     return { label: "Runs", value: String(player.runs) };
//   }
//   if (hasBowl) {
//     return { label: "Wickets", value: String(player.wickets) };
//   }
//   if (hasBat) {
//     return { label: "Runs", value: String(player.runs) };
//   }
//   return { label: "Format", value: player.format || "T20" };
// }
...
//   const hs = headlineStat(player);
//   const sr = player.strike_rate > 0 ? player.strike_rate.toFixed(1) : "—";
//   const avg = player.batting_average > 0 ? player.batting_average.toFixed(1) : "—";
//   const eco = player.economy > 0 ? player.economy.toFixed(2) : "—";

//   return (
//     <Link
//       href={`/MainModules/WplPlayers?id=${player.player_id}`}
//       className="group block min-w-[270px] sm:min-w-[300px] max-w-[300px] snap-start"
//     >
//       <div className="relative bg-[#0f0f13] border border-[#2a2a35] rounded-2xl overflow-hidden h-full flex flex-col transition-all duration-300 hover:border-[#7c3aed]/60 hover:shadow-[0_0_28px_rgba(124,58,237,0.18)] hover:-translate-y-0.5">
...
//           <div className={`w-11 h-11 rounded-full bg-gradient-to-br ${grad} flex items-center justify-center shrink-0 shadow-md`}>
...
//           <ChevronRight
//             size={16}
//             className="text-gray-600 group-hover:text-[#7c3aed] transition-colors shrink-0"
//           />
//         </div>

//         {/* Headline stat */}
//         <div className={`mx-4 mb-3 rounded-xl bg-gradient-to-r ${grad} p-[1px]`}>
//           <div className="bg-[#0f0f13] rounded-[11px] px-3 py-2.5 flex items-center justify-between">
//             <div>
...
//           <div className="bg-[#18181f] rounded-xl p-2.5 text-center">
//             <p className="text-[9px] text-gray-500 uppercase tracking-wider font-medium flex items-center justify-center gap-0.5">
//               <Zap size={8} /> SR
//             </p>
//             <p className="text-sm font-bold text-white mt-0.5">{sr}</p>
//           </div>
//           <div className="bg-[#18181f] rounded-xl p-2.5 text-center">
//             <p className="text-[9px] text-gray-500 uppercase tracking-wider font-medium">
//               AVG
//             </p>
//             <p className="text-sm font-bold text-white mt-0.5">{avg}</p>
//           </div>
//           <div className="bg-[#18181f] rounded-xl p-2.5 text-center">
//             <p className="text-[9px] text-gray-500 uppercase tracking-wider font-medium flex items-center justify-center gap-0.5">
//               <Target size={8} /> ECO
//             </p>
//             <p className="text-sm font-bold text-white mt-0.5">{eco}</p>
//           </div>
//         </div>

//         {/* WPL hover badge */}
//         <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
//           <span className="text-[9px] bg-[#7c3aed] text-white px-2 py-0.5 rounded-full font-semibold tracking-wide uppercase">
//             WPL
//           </span>
//         </div>
//       </div>
...
//         <div className="h-6 w-48 bg-[#1a1a24] rounded-lg animate-pulse" />
//         <div className="h-8 w-48 bg-[#1a1a24] rounded-full animate-pulse" />
//       </div>
//       <div className="flex gap-4 overflow-hidden pb-4">
//         {[1, 2, 3].map((i) => (
//           <div
//             key={i}
//             className="min-w-[270px] h-[200px] bg-[#0f0f13] border border-[#2a2a35] rounded-2xl animate-pulse"
//           />
//         ))}
//       </div>
//     </div>
...
// // ── Main component — self-contained, no context dependency ─────────────────
...
//   // ── Filtered list (inline, no stale state) ─────────────────────────────
//   const filtered = (() => {
...
//         <div className="flex items-center bg-[#1a1a24] border border-[#2a2a35] rounded-full px-3 py-1.5 w-[160px] sm:w-[200px] md:w-[240px] focus-within:border-[#7c3aed]/60 transition">
...
//             className="bg-transparent outline-none text-xs sm:text-sm text-white placeholder:text-gray-600 w-full ml-2"
//           />
//         </div>
//       </div>
...
//             className="text-xs text-[#7c3aed] border border-[#7c3aed]/30 px-4 py-1.5 rounded-full hover:bg-[#7c3aed]/10 transition disabled:opacity-50"
//           >
