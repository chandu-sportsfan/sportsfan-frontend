...
const ACCENT = "#16a34a"; // FIFA green
...
export default function FifaPlayerProfileActions({ player }: Props) {
    ...
    const storageKey = `fifa-player-actions:${player.player_id}`;
    ...
    const handleShareToWhatsApp = () => {
        const text = `Check out ${player.player_name}'s FIFA profile\n${buildShareUrl()}`;
    ...
    const overviewItems = [
        ...
        { value: player.matches_played, label: "MATCHES" },
    ];
        ...
        <div className="flex flex-col gap-4 px-4 md:px-6 pt-4 pb-4">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                <button onClick={handleFollowClick}
                    className="flex flex-1 items-center justify-center gap-2 h-[46px] md:h-[52px] rounded-full text-white text-[14px] md:text-base font-bold tracking-wide border-0 cursor-pointer hover:opacity-90 transition-opacity bg-[#16a34a]">
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={() => setShowShareDialog(false)}>
                        <div className="bg-[#1a1a1e] rounded-2xl border border-white/10 p-4 w-[300px] shadow-2xl" onClick={(e) => e.stopPropagation()}>
                            <div className="flex items-center justify-between mb-3">
                                <p className="text-white text-sm font-semibold">Share FIFA Player Profile</p>
            ...
            <div className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-4 md:p-5">
                ...
                <div className="grid grid-cols-2 gap-3 mt-3">
                    ...
                    <div className="flex flex-col justify-center p-3.5 md:p-4 rounded-xl bg-[#242424]">
                        ...
                        <span className="text-[11px] md:text-xs text-[#777777] mt-1">Team</span>
                    </div>
                    <div className="flex flex-col justify-center p-3.5 md:p-4 rounded-xl bg-[#242424]">
                        <span className="text-[20px] md:text-[24px] font-extrabold text-white leading-tight">
                            {player.season}
                    ...
                    <div className="flex flex-col justify-center p-3.5 md:p-4 rounded-xl bg-[#242424]">
                        ...
                        <span className="text-[11px] md:text-xs text-[#777777] mt-1">Minutes</span>
                    </div>
                </div>
            </div>
        </div>
