...
export default function GlobalActionBar() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-50 right-4 md:bottom-36 md:right-6 lg:bottom-24 lg:right-6 z-50">
        <button
          onClick={() => setDialogOpen(true)}
          className="group relative flex items-center justify-center w-7 h-7 lg:w-14 lg:h-14 rounded-full bg-[#1a1a1a] border border-white/15 shadow-lg hover:shadow-xl hover:border-[#C9115F]/60 hover:bg-[#C9115F]/10 transition-all duration-300 hover:scale-110 active:scale-95"
