...
//     // ── Results list — shared across all 3 breakpoints ────────────────────────
//     const ResultsList = () => (
//         <>
//             {isSearching ? (
...
//                         // ── WPL player detection ──────────────────────────────
//                         const isWPL = result.type === "player" && result.tournament === "womens_ipl";
...
//                                         ) : (
//                                             <div className={`w-full h-full flex items-center justify-center text-white font-bold bg-gradient-to-br ${
//                                                 isWPL
//                                                     ? "from-violet-600 to-fuchsia-500"  // WPL → purple
//                                                     : "from-pink-500 to-orange-500"      // IPL → pink
//                                             }`}>
...
//                                         {/* WPL pill — only for women players */}
//                                         {isWPL && (
//                                             <span className="text-[9px] font-bold uppercase px-1.5 py-0.5 rounded-full flex-shrink-0 bg-[#7c3aed] text-white tracking-wide">
//                                                 WPL
//                                             </span>
//                                         )}
...
//                                     {/* Sub-label for WPL */}
//                                     {isWPL && (
//                                         <p className="text-[10px] text-violet-400/70 mt-0.5 leading-none">
...
type TournamentMeta = {
    label: string;               // pill text shown in dropdown
    sublabel: string;            // second line under player name
    badgeBg: string;             // Tailwind bg class for pill
    badgeText: string;           // Tailwind text class for pill
    avatarFrom: string;          // gradient from
    avatarTo: string;            // gradient to
    jerseyBg: string;
    jerseyText: string;
};
...
const WOMEN_TOURNAMENTS = Object.keys(TOURNAMENT_META);
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    {/* Sub-label: full tournament name */}
                                    {womenMeta && (
