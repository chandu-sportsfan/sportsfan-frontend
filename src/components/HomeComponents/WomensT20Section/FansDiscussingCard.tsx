...
const topics: Topic[] = [
  {
    title: "Harmanpreet\'s 4000 Runs - Elite Legacy Cemented?",
    badge: "POSITIVE",
    badgeStyle: "bg-transparent border border-green-500 text-green-500",
  },
  {
    title: "India T20I Form - England Series Heartbreak",
    badge: "SAD",
    badgeStyle: "bg-[#e91e63] border border-[#e91e63] text-white",
  },
  {
    title: "T20 World Cup 2026 - India\'s New Strategy",
    badge: "EXCITED",
    badgeStyle: "bg-[#7c3aed] border border-[#7c3aed] text-white",
  },
  {
    title: "Shreyanka Patil - First T20 World Cup Main Stage",
    badge: "EXCITED",
    badgeStyle: "bg-[#7c3aed] border border-[#7c3aed] text-white",
  },
];
          ...
          {topics.map((topic, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <span
                  className={`text-[9px] font-bold px-2 py-0.5 rounded-md whitespace-nowrap ${topic.badgeStyle}`}
                >
                  {topic.badge}
                </span>
