    ...
    <div className="flex flex-col justify-between bg-[#111111] border border-gray-800 rounded-xl p-4 w-full h-full min-h-[340px]">
      ...
      <div className="flex-grow flex flex-col justify-center items-center">
        <div className="bg-gradient-to-r from-[#111111] to-[#800f45] border border-gray-800 rounded-2xl w-full p-6 flex items-center justify-center gap-6 relative overflow-hidden">
          ...
          <div className="z-10 flex items-center gap-6 w-full max-w-[280px]">
            <h2 className="text-white text-6xl font-black tracking-tighter">72%</h2>
            <div className="h-16 w-[2px] bg-white/80 rounded-full"></div>
            <p className="text-white text-sm font-medium leading-snug">
              India have won 72% of their T20I matches when Harmanpreet remains unbeaten.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between text-gray-500 mt-6 pt-4 border-t border-gray-800 px-1">
        <div className="flex gap-4">
          <button className="flex items-center gap-1 hover:text-[#ff2a5f] transition-colors"><span className="text-sm">♡</span> <span className="text-xs">384</span></button>
          <button className="flex items-center gap-1 hover:text-white transition-colors"><span className="text-sm">💬</span> <span className="text-xs">62</span></button>
          <button className="flex items-center gap-1 hover:text-green-500 transition-colors"><span className="text-sm">🔁</span> <span className="text-xs">49</span></button>
        </div>
