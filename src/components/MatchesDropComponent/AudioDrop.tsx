...
//         // Add this - listen for 'pause' event  
...
//                 //  Only autoplay once loading is fully done
//                 if (audioReadyToPlayRef.current) {
//                     setPlaying(true);
//                 } else {
//                     // Loading finished after metadata — wait for it
...
//         if (playing) {
//             //  Sync currentTime before playing in case resumeAt was set
//             audio.play().catch(console.error);
...
//                     <button
//                         className="flex items-center gap-2 text-gray-400 hover:text-white mb-6 transition cursor-pointer"
//                     >
//                         <ArrowLeft size={18} />
