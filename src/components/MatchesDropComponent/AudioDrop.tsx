...
const resolveShareImageUrl = () => "/images/share.png";
            ...
            <div className="w-full max-w-[360px] sm:max-w-[400px] bg-[#111114] rounded-[28px] overflow-hidden border border-[#2a2a2e]">
                ...
                <div className="flex items-center justify-between px-4 pt-5 pb-3 bg-[#111114]">
                    ...
                    <button
                        ...
                        className="relative w-8 h-8 rounded-full bg-[#1e1e22] flex items-center justify-center cursor-pointer hover:bg-[#2a2a2e] transition overflow-hidden"
                        ...
                        <div className="p-5">
                            <div className="rounded-[24px] overflow-hidden border border-white/10 bg-[#111114] mb-5">
                                <div className="relative h-48 bg-gradient-to-br from-pink-500/25 via-[#111114] to-orange-500/20">
                                    <img src={resolveShareImageUrl()} alt={audioDrop.title} className="absolute inset-0 w-full h-full object-cover opacity-85" />
                                ...
                                <div className="p-4 text-sm text-white/70">
                                    <p className="line-clamp-3">{audioDrop.description || "Latest audio drop from Sportsfan."}</p>
