...
//                 userId: getUserId(), userName: getUserName(), message: signalMessage.trim(),
//             });
...
//     const handleVideoEnd = () => { setPlaying(false); setElapsed(0); if (videoRef.current) videoRef.current.currentTime = 0; incrementPlays(); };
...
//                 {/* ── Main layout: video left, info right on desktop ── */}
//                 <div className="flex flex-col lg:flex-row gap-6">

//                     {/* Video Player — fixed height, no portrait stretching */}
...
//                                 style={{ height: "480px" }}   // ← fixed height, not aspect ratio
//                                 onClick={togglePlay}
//                             >
//                                 <video
//                                     ref={videoRef}
...
//                             <div className="flex items-center gap-1.5">
//                                 <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
//                                     <rect x="2" y="2" width="9" height="9" rx="1.5" stroke="#666" strokeWidth="1.2" />
//                                     <path d="M5 6.5h3M6.5 5v3" stroke="#666" strokeWidth="1.2" strokeLinecap="round" />
//                                 </svg>
//                                 {video.sizeFormatted}
//                             </div>
//                         </div>
