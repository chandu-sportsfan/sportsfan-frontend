                      ...
                      history.map(h => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full flex items-center gap-2.5 cursor-pointer p-2.5 rounded-xl mb-1.5 text-left border ${
                              isActive
                          ...
                          >
                            <div
                              className={`w-[34px] h-[34px] rounded-[10px] overflow-hidden shrink-0 flex items-center justify-center ${
                                h.isLive
                                  ? "bg-gradient-to-br from-pink-600 to-orange-500"
                                  : "bg-white/[0.06]"
                              }`}
                            >
                              {!h.isLive && <span className="text-[15px]">🏏</span>}
                            </div>
                            <div className="flex-1 min-w-0">
