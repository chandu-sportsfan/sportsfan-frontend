// ─── Drop this section into Profile.tsx ───────────────────────────────────────
// Place it AFTER the "Badges Earned" section and BEFORE the "Activity" section.
// It is NOT a modal — it renders inline in the profile scroll.
//
// Usage inside Profile.tsx return:
//   <RoarJourneySection
//     predictions={actCounts.ROAR_PREDICTION_PARTICIPATE ?? 0}
//     debates={actCounts.ROAR_DEBATE_PARTICIPATE ?? 0}
//     posts={actCounts.total ?? 0}
//     badgeSrcs={unlockedBadgeSrcs}   // string[] of image paths/URLs
//     onToast={onToast}
//   />
