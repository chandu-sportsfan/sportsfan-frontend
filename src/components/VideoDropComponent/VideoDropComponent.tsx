...
// // Mock data array
// const mockVideoDrops: VideoDrop[] = [
//   {
//     title: "Training Session Highlights",
//     subtitle: "Video Drops",
//     description: "Exclusive look at the intensive training session preparing for the next match.",
//     views: 4532,
//     signals: 987,
//     duration: "6:30",
//     durationSecs: 390,
...
//   },
//   {
//     title: "Match Winning Moment",
//     subtitle: "Video Drops",
//     description: "Watch the incredible final over that sealed the victory for the team.",
//     views: 12890,
//     signals: 2345,
//     duration: "4:15",
//     durationSecs: 255,
...
//     room: "Main Arena",
//     engagement: 45,
//     thumbnail: "/images/match-winning.jpg",
//   },
//   {
//     title: "Post Match Interview",
//     subtitle: "Video Drops",
//     description: "Captain shares insights about the team's performance and future strategies.",
//     views: 8765,
//     signals: 1543,
//     duration: "8:45",
//     durationSecs: 525,
...
//     subtitle: "Video Drops",
//     description: "Behind the scenes of the team's rigorous practice sessions.",
//     views: 3210,
//     signals: 654,
//     duration: "5:20",
//     durationSecs: 320,
//     date: "Mar 18, 2026",
//     room: "Training Ground",
//     engagement: 28,
//     thumbnail: "/images/practice.jpg",
//   },
//   {
//     title: "Celebration Moments",
//     subtitle: "Video Drops",
//     description: "Unforgettable celebration moments after the championship win.",
//     views: 15432,
//     signals: 2876,
//     duration: "3:50",
//     durationSecs: 230,
...
//     subtitle: "Video Drops",
//     description: "Expert breakdown of the key strategies used in the tournament.",
//     views: 6543,
//     signals: 1234,
//     duration: "12:15",
//     durationSecs: 735,
...
//     room: "Analysis Room",
//     engagement: 41,
//     thumbnail: "/images/analysis.jpg",
//   }
// ];

// export default function VideoDropCard({ drop = mockVideoDrops[0] }: { drop?: VideoDrop }) {
...
//         setElapsed(e => {
//           if (e >= drop.durationSecs) { 
//             setPlaying(false); 
//             return drop.durationSecs; 
//           }
//           return e + 1;
//         });
//       }, 1000);
...
//   }, [playing, drop.durationSecs]);

//   const mins = Math.floor(elapsed / 60);
//   const secs = elapsed % 60;
//   const timeStr = `${mins}:${secs.toString().padStart(2, "0")}`;
//   const pct = Math.round((elapsed / drop.durationSecs) * 100);
//   const engPct = playing ? pct : drop.engagement;

//   return (
//     <div className="flex justify-center bg-[#0d0d10] min-h-screen p-4 sm:p-6 lg:p-10">
//       <div className="w-full max-w-[360px] sm:max-w-[400px] lg:max-w-[420px] bg-[#111114] rounded-[24px] overflow-hidden border border-[#222226]">

//         {/* Topbar */}
//         <div className="flex items-center justify-between px-4 pt-4 pb-3">
//           <div className="flex items-center gap-3">
//             <button className="w-8 h-8 rounded-full bg-[#1e1e24] flex items-center justify-center border-none cursor-pointer"
...
//             </button>
//             <div>
//               <p className="text-white text-[15px] font-medium leading-tight">Pre - Match Strategy</p>
//               <p className="text-[#777] text-[12px] mt-0.5">{drop.subtitle}</p>
//             </div>
//           </div>
//           <button className="w-8 h-8 rounded-full bg-[#1e1e24] flex items-center justify-center border-none cursor-pointer">
...
//         {/* Video Player */}
//         <div className="mx-3.5 rounded-[14px] overflow-hidden bg-[#1a1a1e]">
//           {/* Video area */}
//           <div
...
//           >
//             {drop.thumbnail && (
//               <img src={drop.thumbnail} alt={drop.title} className="absolute inset-0 w-full h-full object-cover opacity-60" />
//             )}
//             <button
//               onClick={e => { e.stopPropagation(); setPlaying(v => !v); }}
//               className="relative z-10 w-[54px] h-[54px] rounded-full bg-[#e0185a] hover:bg-[#f01e66] flex items-center justify-center border-none cursor-pointer transition"
//             >
//               {playing ? (
...
//           {/* Timestamps */}
//           <div className="flex justify-between px-2.5 py-1.5 text-[11px] text-[#555] font-mono">
//             <span>{timeStr}</span>
...
//           <h1 className="text-white text-[20px] sm:text-[21px] font-medium leading-snug mb-2">
//             {drop.title}
//           </h1>
...
//             {[
//               { label: "Views",    value: drop.views.toLocaleString(),   color: "#e0185a", green: false },
//               { label: "Signals",  value: drop.signals.toLocaleString(), color: "#e0185a", green: false },
//               { label: "Duration", value: drop.duration,                  color: "#1a9e6a", green: true  },
//             ].map(s => (
//               <div key={s.label} className="bg-[#1a1a1e] rounded-xl p-2.5 flex flex-col gap-1.5">
//                 <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider" style={{ color: s.color }}>
//                   <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
//                     {s.label === "Duration" ? (
//                       <>
...
//                   {s.label}
//                 </div>
//                 <span className="text-[18px] font-medium" style={{ color: s.green ? "#1a9e6a" : "#fff" }}>
//                   {s.value}
//                 </span>
//               </div>
//             ))}
...
//           {/* Meta */}
//           <div className="flex items-center gap-3.5 text-[12px] text-[#666] mb-3">
...
//           {/* Engagement bar */}
//           <div className="mb-4">
//             <div className="h-1 bg-[#222226] rounded-full overflow-hidden mb-1.5">
//               <div
//                 className="h-full bg-[#e0185a] rounded-full transition-all duration-300"
//                 style={{ width: `${engPct}%` }}
//               />
//             </div>
//             <p className="text-right text-[11px] text-[#555]">{engPct}% engagement</p>
//           </div>

//           {/* Send Signal */}
//           <button className="w-full bg-[#1a0a12] border border-[#e0185a] rounded-[14px] py-[14px] flex items-center justify-center gap-2 text-[#e0185a] text-[15px] font-medium hover:bg-[#260d18] transition cursor-pointer">
...
// // Export mock data for external use if needed
// export { mockVideoDrops };
