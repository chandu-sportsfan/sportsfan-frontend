                ...
                <div className="flex flex-col lg:flex-1 lg:min-w-0">
                    ...
                    <div className="relative w-full aspect-video bg-[#1a0a14] overflow-hidden">
                        ...
                        <div className="absolute bottom-2.5 right-3 flex flex-col items-center gap-0.5 z-20">
                            <div className={`w-[30px] h-[30px] lg:w-[150px] lg:h-[150px] rounded-full border-2 ${room.borderColor || "border-pink-500"} bg-[#333] flex items-center justify-center text-[10px] font-bold overflow-hidden`}>
                                {room.displayPicture ? (
                                    <img src={room.displayPicture} alt={room.name} className="w-full h-full object-cover" />
                                ) : (
