        ...
        return (
            <div className="min-h-screen w-full flex flex-col items-center justify-center gap-6 relative bg-gradient-to-b from-[#3a0000] via-black to-[#120000] px-4 py-8">
                ...
                <div className="flex flex-col items-center z-10 text-center">
                    ...
                    <h1 className="text-white text-xl sm:text-2xl font-semibold text-center">Change Password</h1>
                    <p className="text-gray-400 text-xs sm:text-sm text-center mt-2 px-2">
                        First time login. Please set a new password for<br />
                        <span className="text-orange-400 break-all">{email}</span>
                    </p>
                </div>
