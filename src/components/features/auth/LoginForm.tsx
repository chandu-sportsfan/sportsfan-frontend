...
//                             <p className="text-gray-400 text-sm text-right hover:underline cursor-pointer">
//                                 Forgot Password?
//                             </p>
//                         </div>
//                     </Link>
...
// ❌ REMOVE this - don't use absolute URL
// const ADMIN_API_URL = process.env.NEXT_PUBLIC_ADMIN_PANEL_URL || "https://sportsfan360.vercel.app";
